        ...
        >
          ...
          <div class="mt-auto">
            <a 
              ...
              class="inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-lg bg-gray-900 text-white text-sm font-medium hover:bg-gray-700 transition-all active:scale-95 shadow-md w-full sm:w-max"
            >
